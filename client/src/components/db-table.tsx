      ...
      cell: (product: BeerProduct) => (
        <div className="text-right space-x-2">
          <Button 
            ...
            className="text-beer-brown hover:text-beer-gold"
          >
      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            {/* Botão para deletar todos os produtos */}
            <Button 
              variant="destructive" 
              className="flex items-center"
              onClick={() => {
                if (window.confirm('WARNING: This will delete ALL products from the database. This action cannot be undone. Are you sure?')) {
                  deleteProducts(products.map(p => p.product_id));
                }
              }}
            >
